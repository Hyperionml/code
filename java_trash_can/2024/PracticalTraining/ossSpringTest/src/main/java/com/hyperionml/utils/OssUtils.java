...
public class OssUtils {
    ...
    public void massUpload(ArrayList<img> urls) throws IOException {
        ...
        /*Files.walkFileTree(startPath, new SimpleFileVisitor<>() {
            ...
            public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
                ...
                if (index > 0) {
                    objectName = objectName + file.toString().substring(index + 1);
                }else {
                    objectName = objectName + file;
                }

                try {
                    ossClient.putObject(new PutObjectRequest(bucketName, objectName, new File(file.toString())));
                } catch (Exception e) {
